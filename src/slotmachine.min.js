...
var slotMachine = function (a, b, c) {
     ...
     d.endSpin = function () { 
                    ...
                    function () { 
                         ...
                         0 == startSeqs["mainSeq" + c.mainSeq].totalSpinning) { var a = ""; 
     ...
     d.endAnimation = function (a) { 
                    ...
                    startSeqs["mainSeq" + c.mainSeq].totalSpinning--, startSeqs["mainSeq" + c.mainSeq]["subSeq" + c.subSeq].endNum = a }, 
...
counterPlusElem.addEventListener("click",()=>{
     //50USD is 50 000 nx
     //so 4900 nx is 4.9$ dollars
     countNx+=4900;
     countCash+=4.9;
     counterDisplayElemNx.innerHTML = countNx;
     counterDisplayElemCash.innerHTML = countCash;
});
